    ...
    const loadChats = async () => {
        try {
            ...
            const mapped = res.data.map((chat) => {
                const other =
                    chat.participants.find((p) => p._id !== userData?._id) ||
                    chat.participants[0];
                ...
                return {
                    ...
                    image:
                        ...
                        `https://i.pravatar.cc/50?u=${other._id}`,
            ...
            {chats.length === 0 ? (
                <View style={styles.emptyContainer}>
                    ...
                    <Text style={styles.emptySubtext}>
                        Your conversations will appear here once you're
                        connected with a client or admin.
                    </Text>
                </View>
            ) : (
