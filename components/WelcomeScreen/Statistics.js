        ...
        <View style={styles.container}>
            ...
            >
                ...
                <Animated.View style={{ opacity: anim.contentOpacity }}>
                    <Text style={styles.title}>Real-time Statistics</Text>
                    <Text style={styles.description}>
                        Access real-time updates on locations, task progress and
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => navigation.replace("getLocation")}
                    >
