        ...
        <View style={styles.container}>
            ...
            >
                ...
                <Animated.View style={{ opacity: anim.contentOpacity }}>
                    <Text style={styles.title}>Your Workday Simplified</Text>
                    <Text style={styles.description}>
                        Technika keeps your jobs, tasks, and workflow in one
                        place - so you can focus on getting the job done.
                    </Text>
